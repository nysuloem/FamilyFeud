...
The playing family sees its current strike count on their phones during normal family play. It is hidden from opponents, the TV display, steals, and later stages. The supplied faceoff walkup recording plays softly under the host’s contestant invitation and stops before the question begins.
