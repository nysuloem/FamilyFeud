...
The Dawson opening uses a period-style illuminated yellow oval title. The main game uses the supplied 2019 × 1140 wide stage as a full-frame image layer so the complete photograph remains visible on TV and remote screens. Richard's host introduction returns to his isolated portrait rather than showing the stage composite. Image prompts and asset paths are recorded in `assets/IMAGE_EDIT_NOTES.md`; earlier assets are preserved.
