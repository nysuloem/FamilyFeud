...
The set uses the supplied Dawson-era stage reference with an interactive eight-slot flip board and dot-score displays. Fast Money uses a black board with pale yellow lettering and covered tile rows. Richard and the active contestant appear together below the board during timed play. Richard uses the supplied question-card-reading pose, restored and isolated from the broadcast overlays. The first reveal pairs the answer column with Richard’s arm-around-the-contestant composition; the second reveal uses both columns for answers with no portraits. The clock only appears during preparation and timed play, never during either reveal or the final result. Questions are spoken, not shown during play; each response and score is revealed individually. Two hundred combined points wins $10,000 in the Dawson era and $20,000 in the Harvey era, while a lower score wins $5 per point. During the second reveal, reaching 200 ends Fast Money immediately and leaves all later answers covered. The win celebration leads into the supplied credits music, then the separate “Made by Jason” recording and illustrated production card; the original “Made in Georgia” tag is not used. Fast Money questions are pre-generated once for both contestants to reduce speech-loading delays.

The Dawson opening reuses the same blue-grey set, gold oval, decorative flourishes, bulbs and Rye lettering as the family-introduction panels. That light-blue set background remains consistent behind the opening, family introductions, Richard's portrait, gameplay and Fast Money. The main game uses the supplied stage as a compact full-frame WebP image layer so the complete photograph reaches browsers intact and remains visible on TV and remote screens. Richard's host introduction uses his isolated portrait rather than the stage composite. Family announcements are preloaded while the opening plays; the music bed crossfades into the opening and host clips, with only brief visual transition beats between families.
