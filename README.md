...
The main Dawson game now uses the supplied 2019 × 1140 wide stage image. The host introduction uses a separate stage composite with Richard standing on the floor, while the clean stage remains unobstructed during gameplay. Image prompts and asset paths are recorded in `assets/IMAGE_EDIT_NOTES.md`; earlier assets are preserved.
